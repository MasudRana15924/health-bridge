        ...
        <div>
            <div className="w-full   mb-5 mt-20 grid lg:grid-cols-2 ">
                ...
                <div className="text-start ml-5 text-sm font-semibold leading-6 text-gray-900">
                    ...
                    <label for="appointment-modal" className=" border-0 btn bg-teal-400 mt-7  w-3/4 mx-auto mb-10 hover:bg-teal-400 hover:border-teal-400">Hire Nurse</label>
            ...
            <div className="grid grid-cols-2">
                ...
                </div>
                {
                    user ? <div className="w-3/4  ml-5">
                        ...
                        <br />
                        <button class="btn w-full mt-2 bg-teal-400 border-teal-400 hover:bg-teal-400 hover:border-teal-400" onClick={reviewSubmitHandler}>Submit</button>
