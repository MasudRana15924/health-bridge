...
const Acheivement = () => {
    return (
        <div className="p-5 lg:p-0 lg:w-3/4 mx-auto grid grid-cols-1 lg:grid-cols-3 gap-4 mb-5 mt-5 md:mt-48 lg:mt-32">
        <div className="stat place-items-center stats shadow h-48 bg-black">
            ...
            <div className="stat-value text-violet-600">2.6M</div>
        ...
        <div className="stat place-items-center stats shadow h-48 bg-black">
            ...
            <div className="stat-title text-white text-xl">New Registers</div>
            <div className="stat-value text-violet-600">1,200</div>
