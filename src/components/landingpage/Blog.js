...
const Blog = () => {
    return (
        <div className="blogs mt-16 mb-10">
                ...
                <div className="mt-12 lg:mt-28 md:mb-20 lg:mb-20">
                    <div className="h-96 bg-white ">
                        ...
                        <div className="card-body text-center">
                            <h2 className="text-center lg:text-xl 2xl:text-2xl font-semibold ">
                             Benefits of Consulting Online Doctor 
                            </h2>
                            <p className=" text-start text-sm font-semibold leading-8 text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit.   <button className="btn btn-sm bg-violet-600 border-violet-600 lg:w-2/4 2xl:w-1/4 text-xs ">Read More</button></p>
