...
import { createNurses } from '../../state/admin/create/createNurseSlice';
        ...
        <div className="max-w-full mx-auto ">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:col-span-2 gap-2">
                ...
                <div className="w-3/4 mb-5 mt-12 p-5">
                    <p className="text-start text-3xl ">Create An Nurse</p>
                    <form action=""  onSubmit={createNurse}>
                        ...
                        <button className="btn bg-violet-900 mt-5 h-12 w-full text-white font-semibold text-center mb-5">Create </button>
                    </form>
                </div>
