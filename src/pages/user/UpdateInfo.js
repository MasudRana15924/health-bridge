...
const UpdateInfo = () => {
  ...
  return (
    <div className="p-3 lg:p-10 bg-white mt-20 mb-20">
      <div className="max-w-full mx-auto ">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:col-span-2 gap-2">
          <div className="hidden lg:block  w-2/4 lg:mx-auto text-end mt-20 mb-5">
            <UserSidebar></UserSidebar>

          </div>
          <div className="lg:w-3/4 mb-5 lg:mt-32 lg:p-5">
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h2 className="mt-5  text-2xl font-medium mb-4 text-start">Update Your Info</h2>

              <form onSubmit={registerSubmit}>
                <div className="mb-2 ">
                  <p className="text-start text-sm text-blue-300">What is your Name?</p>
